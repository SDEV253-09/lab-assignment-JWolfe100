...
function login($username, $password) {
	...
	// check if username is unique
	$result = $conn->query("select * from user where username='".$username."' and password = shal('".$password."')");
	if (!$result) {
...
function change_password($username, $old_password, $new_password) {
	...
	// if the old password is right change their password to new_password and return true else throw an exception
...
function reset_password($username) {
	// set password for username to a random value return the new password or false for failure
